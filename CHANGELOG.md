...
* add structured error codes (PLB-XXXX) with documentation links ([692f9d4](https://github.com/slyt3/plumber/commit/692f9d429d779eaa3df27f743314c7b7e247533f)), closes [#92](https://github.com/slyt3/plumber/issues/92)
* **analysis:** Add --mr-comment to create mr comments during analysis. Add --badge to create/update Plumber compliance badge when running on default remote branch ([4cba483](https://github.com/slyt3/plumber/commit/4cba4839ce3512ef2da7ff5b9512dca701d2a7f7))
* **analysis:** Allow auto-detection for gitlab url and project during analysis + update banner ([e7a20e6](https://github.com/slyt3/plumber/commit/e7a20e6e2b49bdf7cc7805effebc765e73930b2d))
* **analysis:** Revert CI_JOB_TOKEN ([6c12fb5](https://github.com/slyt3/plumber/commit/6c12fb59ad73147ca96c3e58ce570eab751706eb))
* **analyze:** add --controls and --skip-controls control filtering ([9a9aca0](https://github.com/slyt3/plumber/commit/9a9aca0a50e63eb27a7f7c8f5470ae6922ff425c))
* **analyze:** Make conf and threshold optional ([bf6a4df](https://github.com/slyt3/plumber/commit/bf6a4dfc3c306d0bb9bd3cd8e7e6a20bcaf9522a))
* **artifact:** Add new concept: Pipeline Bill Of Materials (PBOM) and add cyclonedx output format support ([7097605](https://github.com/slyt3/plumber/commit/7097605f85123ea7599e67d7b22e34bfa13e726b))
* **brew:** Enable automatic updating of brew tap formula repo upon new release ([ead9860](https://github.com/slyt3/plumber/commit/ead98601a2e355403975b087a5f0da1b3653fb76))
* **brew:** Test release 0.1.26 ([1848d52](https://github.com/slyt3/plumber/commit/1848d5248fd9c38cc54d8da11b24ef9694afb48d))
* **build:** Add platforms binary releases ([01d9bfa](https://github.com/slyt3/plumber/commit/01d9bfa79b80cf9d2c7ea6d1984e2acc7a4db9bb))
* **build:** Move to alpine to make command customizable in CI ([763bcf3](https://github.com/slyt3/plumber/commit/763bcf3eadd21fdf53503033b00ced44b1a6b862))
* **ci:** Add dependabot ([3480a77](https://github.com/slyt3/plumber/commit/3480a777b3ef3bcf1dd72269da67aad28c3fcf0b))
* **ci:** Add go vuln checks and ask dependabot to update go deps ([3e588c7](https://github.com/slyt3/plumber/commit/3e588c78004fbe63ee6a4f086a2f0112ddaa6f3f))
* **ci:** Add openssf best practices ([c99cc15](https://github.com/slyt3/plumber/commit/c99cc1514ae1fa05e8ea2f5501210a798bba3434))
* **ci:** add SLSA 3 provenance, OpenSSF Scorecard, and security hardening ([5dad4a3](https://github.com/slyt3/plumber/commit/5dad4a38550416da5bc2f8d59ac9373e9eb00423))
* **ci:** Replace trivvy with grype ([984286f](https://github.com/slyt3/plumber/commit/984286f2ca871792b8a12e34bea7a647cb72450f))
* **ci:** Run on ubuntu 24.04 instead of latest ([b5473d2](https://github.com/slyt3/plumber/commit/b5473d2d527dc6672f332670d729f2eb4701944f))
* **ci:** Start adding test, lint, scan and pin versions by digest ([ec77e70](https://github.com/slyt3/plumber/commit/ec77e709864ddf621ca5337de3345c5c18627466))
* **cmd:** Add --fail-warnings on the analyze and config validate commands ([fbc5839](https://github.com/slyt3/plumber/commit/fbc58391ebc1e51d412588ed5748587a6e125227))
* **cmd:** Add new flag --ci-config-path to allow overriding .gitlab-ci.yml ([150e230](https://github.com/slyt3/plumber/commit/150e2308f39cab64b54e4dba49b24770053ab4a3))
* **cmd:** Add progress spinner during analysis ([80b1bad](https://github.com/slyt3/plumber/commit/80b1bad2a9b556d0e8414e2c90b4199cda5b26c4)), closes [#64](https://github.com/slyt3/plumber/issues/64)
* **cmd:** differentiate exit codes for compliance vs runtime errors (closes [#61](https://github.com/slyt3/plumber/issues/61)) ([b07f2f8](https://github.com/slyt3/plumber/commit/b07f2f8d58e40e4dabdc1dd48beec0019854c2c7))
* **cmd:** notify user when a newer version of plumber is available ([deca33f](https://github.com/slyt3/plumber/commit/deca33f74d9c2f1c2468d8ce98a5693df1fa9d9c)), closes [#39](https://github.com/slyt3/plumber/issues/39)
* **cmd:** validating config file before analysis ([a1dc4bd](https://github.com/slyt3/plumber/commit/a1dc4bd7c14d4fe230f770849c0b12683fba8323))
* **component:** Allow verbosity in component ([b59015a](https://github.com/slyt3/plumber/commit/b59015a9bd64213ca0b3cf21ea02b16e833eee13))
* **conf:** Add conf diff ([d48e5e1](https://github.com/slyt3/plumber/commit/d48e5e118d4a57fbd3ed260158a68c0f82bb1e17)), closes [#62](https://github.com/slyt3/plumber/issues/62)
* **conf:** Add conf view and move generate under conf ([8e549e9](https://github.com/slyt3/plumber/commit/8e549e97ab462dbf46d7f5d25dea8fd77989c796))
* **conf:** Add reference to examples in test file for required includes ([a8ec829](https://github.com/slyt3/plumber/commit/a8ec82961ab5152a3b6a1bff938afbc63978b7e6))
* **conf:** Allow conf generation with command ([7390e76](https://github.com/slyt3/plumber/commit/7390e763055c23a44506ba43db2331fb09a0b0e7))
* **conf:** Correct dockerfile and release file ([34263ec](https://github.com/slyt3/plumber/commit/34263ec71a90183a65e9b1511e90f34ce6d2e1a2))
* **config:** Add ValidateKnownKeys to warn on unknown config keys ([4c33ca3](https://github.com/slyt3/plumber/commit/4c33ca3c980cc57419b7b457bfae09c7543ba8d3)), closes [#58](https://github.com/slyt3/plumber/issues/58) [#58](https://github.com/slyt3/plumber/issues/58)
* **conf:** Introduce priority and automatic detection of conf files ([91ef31b](https://github.com/slyt3/plumber/commit/91ef31b3a43b1fa150a8fba1c2c880a2220b80ef))
* **control:** Add 3 new controls ([591a850](https://github.com/slyt3/plumber/commit/591a8509f47c1cc21eb3bf71ad185163368ba033))
* **control:** Add control to check unverified inline script exceution ([cbb416b](https://github.com/slyt3/plumber/commit/cbb416b0c4984be268fd1c8accde589af925578f))
* **control:** Make component collecetion compatible with gitlab built-in components ([532f071](https://github.com/slyt3/plumber/commit/532f071544c58f8c3af1cbf4771b43a1e296a799))
* **controls:** Add debug trace detection control ([5e08b97](https://github.com/slyt3/plumber/commit/5e08b974d17ee2468768f6b8a2917b09eddfe0ff)), closes [#86](https://github.com/slyt3/plumber/issues/86)
* **controls:** add image digest pinning control ([ea538a9](https://github.com/slyt3/plumber/commit/ea538a954def56d4695b0d766f3bb1aff8ee7bbd))
* **controls:** Add overridden component and templates issue & integration into pbom and cyclonedex ([e970c27](https://github.com/slyt3/plumber/commit/e970c27697c29873057a5f6b6109715ba47d3896))
* **controls:** Add securityJobsMustNotBeWeakened control: ([6dbad42](https://github.com/slyt3/plumber/commit/6dbad42f3ebf4fa49895bb07840a976ced4f4dc3))
* **controls:** Add unsafe variable expansion control for user-filled predefined variables ([0f7ec72](https://github.com/slyt3/plumber/commit/0f7ec723ff0b03ffb1c345fa393eaa8f9e022dd7))
* **controls:** Rename control outputs and config to make them more human-readable & Start using CI_JOB_TOKEN if in the CI ([6669707](https://github.com/slyt3/plumber/commit/66697073a13a337230f88a5ba1213def645f474d))
* **control:** Support Natural Language in pipeline inclusion for templates and components ([59c4edd](https://github.com/slyt3/plumber/commit/59c4edddb2750296d06d282e7c5efd272e3aa81d))
* **init:** Add first version of plumber with 3 controls, gitlab-ci and in-terminal support ([278c2d9](https://github.com/slyt3/plumber/commit/278c2d9ca38b4ac434ff49587abde53c9eb825f6))
* **license:** Update license in readme to MPL-2.0 ([4cbab86](https://github.com/slyt3/plumber/commit/4cbab86370f2ee3c5d010d5888e17e1d6fa9d445))
* **local:** Enable lint, validation and analysis of local .gitlab-ci.yml as well as local reoslution of include: local types. ([5a2a3aa](https://github.com/slyt3/plumber/commit/5a2a3aa3b67c8489289bf98f47f9494f386f6458))
* **log:** Improve logging experience ([426bcf8](https://github.com/slyt3/plumber/commit/426bcf817bc62c382b5487443832b49372cbe890))
* **naming:** Rename components to plumber, no need for the analyze suffix ([53a0816](https://github.com/slyt3/plumber/commit/53a08165e7d879099606505c98cce7abc45715eb))
* **output:** Improve readability of printed results ([97d708f](https://github.com/slyt3/plumber/commit/97d708f75d5b76fba6bb3724543837eb371f5c04))
* **release:** Downgrade feat to patch ([eb30e81](https://github.com/slyt3/plumber/commit/eb30e8183466068954edbd4e700986e02bfd72af))
* **update:** Empty commit ([b7bd04f](https://github.com/slyt3/plumber/commit/b7bd04fa8ab8430c15afd625ea27ce3ae2030e8e))
* **UX:** Define default output file, add output json example ([3dbfa1c](https://github.com/slyt3/plumber/commit/3dbfa1c9172b561e35ce52d834e794bc2fb08091))
* **UX:** If a control is misisng from .plumber.yaml simply skip it instead of returning an error ([3eec388](https://github.com/slyt3/plumber/commit/3eec388d75d0e28792c580dc95c79f89663af5e3))
* **UX:** Integrate the control pinned by digest inside the immutable one ([87bd450](https://github.com/slyt3/plumber/commit/87bd45074c7d0710f67dfe23e486421eda1baf39))
* **version:** async update check with opt-out ([a1ef745](https://github.com/slyt3/plumber/commit/a1ef74553e85c2341e803ea4ec683f6f0c4d6e31))


### 🐛 Bug Fixes

* **analysis:** Fix bug where analyzed branch was being mistaken for branches to protect ([afdd5f8](https://github.com/slyt3/plumber/commit/afdd5f8424a3a05120e50feb3dd99909bd5dba6a))
* **analysis:** Fix output that --failing-warnings exits with code 2 ([2a23489](https://github.com/slyt3/plumber/commit/2a2348924758460d6a7c45f02afc83da27fbe27a))
* **analysis:** If no controls ran (e.g., data collection failed), compliance is 0% - we can't verify anything ([7ec0e72](https://github.com/slyt3/plumber/commit/7ec0e72ca459539c4a8e4d4fdbc04faf01ddfae8))
* **branch:** use correct SHA for ciConfig query when --branch is specified ([1729084](https://github.com/slyt3/plumber/commit/1729084509de141d282e3a3d49c62fe7864e385e))
* **brew:** Typo in release ([6c80575](https://github.com/slyt3/plumber/commit/6c80575c26f7294e8fa3a1553d10aa3f88864adb))
* **brew:** Typo in release ([4d7b905](https://github.com/slyt3/plumber/commit/4d7b905d84e47f25cda4c7b770b0f8660f453f7e))
* **bug:** Cleanup some dead code ([fa7e1ae](https://github.com/slyt3/plumber/commit/fa7e1ae3f445ed2047c5ab4ef0a4a66f0bc8ad93))
* **build:** Move release creation to after asset upload ([bc96e39](https://github.com/slyt3/plumber/commit/bc96e39f0a4fc56185b62199a1f0da8e6a503367))
* **ci:** Allow slsa3 stage to write ([fea8113](https://github.com/slyt3/plumber/commit/fea8113e6bac78eae5226d533bd4877601f00f72))
* **ci:** Bump semantic release and upload artifact versions ([26d81f9](https://github.com/slyt3/plumber/commit/26d81f9d1e2aa1bc061f3da22b4b428c789c358d))
* **ci:** Enable attestation arrival in artifacts ([8de06af](https://github.com/slyt3/plumber/commit/8de06affa41da3f5b7ced83a192d3bbdbc42d056))
* **ci:** Ensure slsa3 attestation is uploaded ([29a33c0](https://github.com/slyt3/plumber/commit/29a33c0c2a8a91e03f96a74d23e4738a228dafae))
* **ci:** Fix CI lint issues ([5288379](https://github.com/slyt3/plumber/commit/528837904a46b7b6334bbfe5f767d200faebdc81))
* **ci:** Improve scorecard score: ([c784ba6](https://github.com/slyt3/plumber/commit/c784ba63af49208639b4ba9678c447ba88ee92d5))
* **ci:** Make salsa upload artifacts before release ([bff7fcb](https://github.com/slyt3/plumber/commit/bff7fcbb8fe1a93d8dcbbe877b6eccc83fcf0792))
* **ci:** Pin builder image ([d8b88f9](https://github.com/slyt3/plumber/commit/d8b88f9322f7d16d8d1218fa290c1a329d715955))
* **ci:** Update versions and creds handling: ([cb3477a](https://github.com/slyt3/plumber/commit/cb3477aba3d2a46f1ce70b7b57bfc43abba9b5bc))
* **comment:** Add timeout comment to client ([15df3f0](https://github.com/slyt3/plumber/commit/15df3f002dea5c9ba5a6a95b9943eafa1dc0230d))
* **component:** Add full docker path to plumber as trusted ([d7732c8](https://github.com/slyt3/plumber/commit/d7732c8d1fefd7f12730e60e963a703d2a120a64))
* **config:** Fix compilation issues + make validation recursive to test subkeys ([405abe4](https://github.com/slyt3/plumber/commit/405abe4dc7f78f2bee3e72b7e94f7f9a7568c4d7))
* **control:** Add doc and fix edge cases: ([13359f7](https://github.com/slyt3/plumber/commit/13359f7f57c2964e3b3a73ca9243863f83de79a0))
* **control:** Disable sha pin by default and update readme ([1d24837](https://github.com/slyt3/plumber/commit/1d2483747880d2f6f53b87b64064975bffb313e1))
* **controls:** Fix bug in controls parsing and swap around some functions and files ([cdf0507](https://github.com/slyt3/plumber/commit/cdf050792ce83b674ce80429f63767d81c90f321))
* **detection:** support SSH URL and Git protocol formats in remote auto-detection ([8e162aa](https://github.com/slyt3/plumber/commit/8e162aaf7a9f21cedd183edf2a3aa00c6dc91b5d)), closes [#36](https://github.com/slyt3/plumber/issues/36)
* **doc:** Add plumber to trusted images ([2a80e1a](https://github.com/slyt3/plumber/commit/2a80e1a831d42b31d75a5af5407a2a2e7582473a))
* **dockerfile:** Update builder image to remove vulns ([7d620c9](https://github.com/slyt3/plumber/commit/7d620c9c04a63310dadc1d55f179b4b035dc5428))
* **issues:** Update issues link ([bc42f2f](https://github.com/slyt3/plumber/commit/bc42f2fdd8c0b74e210d254423e57951327aa48a))
* **issues:** Update issues urls and prefix ([7ced522](https://github.com/slyt3/plumber/commit/7ced52221ba9b7c5be9670ad386d56fc409e099f))
* **license:** Update to use Elv2 license ([01656d0](https://github.com/slyt3/plumber/commit/01656d0664524323264bd5cbd7d1cb3419e1f7ce))
* **naming:** Fix further naming convention with plumber ([3389f25](https://github.com/slyt3/plumber/commit/3389f2581be70a079990490e0880b3f15160c972))
* **naming:** Rename to plumber and disable majors ([f442113](https://github.com/slyt3/plumber/commit/f442113514cebd654431a80e2d30b2ea1289dbfa))
* **pipeline:** Attach attestation to container ([e465aa2](https://github.com/slyt3/plumber/commit/e465aa2de339352e53dd933607dfa7f5f8e00102))
* **readme:** Bump to 0.1.71 ([ae64855](https://github.com/slyt3/plumber/commit/ae64855db19dce1396186357b41f2d067776f42f))
* **rebase:** Rebase on main and add spinner ([20e8c63](https://github.com/slyt3/plumber/commit/20e8c63c5334875e467244fb55bcb059e978c3b8))
* **release:** empty commit to trigger release and push ([e8bd954](https://github.com/slyt3/plumber/commit/e8bd954354e6c11ceef9fc53c89d634196a0e7af))
* **release:** Persist creds throughout release cycle ([4483cf0](https://github.com/slyt3/plumber/commit/4483cf0fc8704f0763f95ee8bfc28462be66e157))
* **variables:** Fix self referential variable ([d5aa9a9](https://github.com/slyt3/plumber/commit/d5aa9a93891b61c7a70a63f533d676084820a03a))


### ♻️ Refactoring

* **cmd:** extract config validation logic ([db02f52](https://github.com/slyt3/plumber/commit/db02f524a28a83645631a0c7325bea161f1d86db))
